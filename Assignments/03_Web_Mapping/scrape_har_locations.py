...
# === CONFIGURATION ===
HAR_FILE = "www.pinterest.com.har"  # Replace with your HAR filename
OUTPUT_MAP = "pinterest_ip_map.html"
...
#     ip, url = ip_item
#     print(f"Geolocating IP: {ip} for URL: {url}")
...
def build_map(
    ...
    # additionally save data as a GeoJSON file
    with open("ip_locations.geojson", "w", encoding="utf-8") as f:
        json.dump(geojson_data, f)
    print("GeoJSON saved to: ip_locations.geojson")
